...
#' Read in original se object in case minor random changes in the SCTransform/ICA/UMAPICA/UMAP has occurred
...
```{r dimred_umap_plot_qc, fig.width=10, fig.height=8.5}
pt_size <- 0.25
...
pdf(useDingbats = F, file = file.path(DIR_FIG, paste0(fname, ".pdf")), width = 16, height = 5);p;dev.off()
...
pdf(useDingbats = F, file = file.path(DIR_FIG, paste0(fname, ".pdf")), width = 6, height = 5);p2;dev.off()
...
pdf(useDingbats = F, file = file.path(DIR_FIG, paste0(fname, ".pdf")), width = 14, height = 6);p;dev.off()
...
pdf(useDingbats = F, file = file.path(DIR_FIG, paste0(fname, ".pdf")), width = 14, height = 7);p;dev.off()
...
pdf(useDingbats = F, file = file.path(DIR_FIG, paste0(fname, ".pdf")), width = 7, height = 12); p1;dev.off()
...
pdf(useDingbats = F, file = file.path(DIR_FIG, paste0(fname, ".pdf")), width = 14, height = 5.4); p2;dev.off()
...
pdf(useDingbats = F, file = file.path(DIR_FIG, paste0(fname, ".pdf")), width = 10, height = 6);p2;dev.off()
